...
http_conn::LINE_STATUS http_conn::parse_line() {
    char temp;
    /* m_checked_index指向m_read_buf中当前正在分析的字节，*/
...
bool http_conn::write() {
    ...
    ssize_t bytes_to_send = m_write_idx;
...
void http_conn::add_headers(size_t content_length) {
    add_content_length(content_length);
    add_linger();
    add_blank_line();
}

bool http_conn::add_content_length(size_t content_length) {
